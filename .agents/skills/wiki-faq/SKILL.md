---
name: wiki-faq
description: Создание и поддержка FAQ-страниц в вики DDPA: быстрые ответы на основе данных из каталога raw/ и существующих wiki-страниц, без gap analysis.
---
...
5. **Create page** in `faq/` with frontmatter:
   - `title` = вопрос (например, «Какой CRM выбрать для малого бизнеса?»)
