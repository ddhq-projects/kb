---
name: wiki-query
description: Use when answering user questions strictly from wiki pages, with citations and optional filing of the answer into faq/ plus index/log updates.
---
...
4. Ask whether to file the answer as a new page in `src/content/docs/faq/`.
5. If user agrees:
...
- If filed: FAQ page exists and index/log are updated.
