---
name: wiki-init
description: Use when bootstrapping or repairing the DDPA Knowledge Base wiki structure, schema rules, index, and log so all other wiki operations can run consistently.
---
...
- `business/clients/`, `business/finance/`, `business/processes/automation/`, `business/processes/communication/`, `business/processes/saas/`, `business/staff/`
- `lifestyle/productivity/`, `lifestyle/self-development/`, `lifestyle/health/`, `lifestyle/smart-home/`, `lifestyle/leisure/`
- `ai/`, `dev/`, `faq/`, `cheatsheet/`
