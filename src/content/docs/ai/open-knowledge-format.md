...
**Open Knowledge Format (OKF)** — открытая спецификация от Google Cloud (v0.1, июнь 2026), которая формализует паттерн [LLM Wiki](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f) Андрея Карпаты в портативный, интероперабельный формат. OKF — вендорно-нейтральный стандарт для представления метаданных, контекста и курированных знаний, которые нужны современным AI-системам.
